...
?>
    ...
    <div class="form-group">  Date of Birth  
        ...
        ?>
              ...
              <div class="form-group">  
                <textarea class="form-control " id="BIRTHPLACE" name="BIRTHPLACE" placeholder= "No. of year of experience" type="text" value="" required  onkeyup="javascript:capitalize(this.id, this.value);" ></textarea>
              </div>
              <div class="form-group"> 
                 <input class="form-control " id="TELNO" name="TELNO" placeholder= "Contact No." type="text" any value="" required pattern="[0-9]{1,10}" onkeyup="javascript:capitalize(this.id, this.value);" >
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                 <input  class="form-control " id="USERNAME" name="USERNAME" placeholder="Username" pattern="[a-zA-Z0-9]{3,20}"   onkeyup="javascript:capitalize(this.id, this.value);" >
              ...
              <div class="form-group">
               Marks:   <input  class="form-control " id="DEGREE" name="DEGREE" placeholder="Graduation Marks"    onkeyup="javascript:capitalize(this.id, this.value);" >
