 ...
 */
  ...
  <body>
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="<?php echo web_root; ?>">JobZ</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <?php if (!isset($_SESSION['APPLICANTID'])) { ?>
             ...
             <?php }else{ ?>
              ...
              <li class="nav-item"><a class="nav-link" href="<?php echo web_root.'applicant/';?>"><i class="fa fa-user"></i><?php echo $appl->FNAME. ' '.$appl->LNAME ;?></a></li>
...
<!-- footer started -->
        ...
        <div class="row mb-5">
        	<div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <p>Our company is for your bright future. Unleash your creativity for getting excellent job.</p>
              <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-3">
              <li class="ftco-animate"><a href="https://twitter.com/jobz_bussiness/media" target="_blank"><span class="icon-twitter"></span></a></li>
                <li class="ftco-animate"><a href="https://www.facebook.com/profile.php?id=100090516824215" target="_blank"><span class="icon-facebook"></span></a></li>
                <li class="ftco-animate"><a href="https://www.instagram.com/jobz.pvt.ltd/" target="_blank"><span class="icon-instagram"></span></a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                <li><a href="index.php?q=hiring" class="py-2 d-block">Hiring now</a></li>
                <li><a href="index.php?q=company" class="py-2 d-block">Company</a></li>
                <li><a href="<?php echo web_root; ?>admin/" class="py-2 d-block">Post a Job</a></li>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-4">
              <h2 class="ftco-heading-2">Essentials</h2>
              <ul class="list-unstyled">
             
                <li><a href="index.php?q=Contact" class="py-2 d-block">Contact</a></li>
                <li><a href="index.php?q=About" class="py-2 d-block">About Us</a></li>
               
                <li><a href="#top" class="py-2 d-block">back To Top</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">302 street,rajapeth behind hdfc bank Amravati</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+91 072 3792 3234</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">JobZpvtltd@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | JobZ
