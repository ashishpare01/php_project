        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">JobZ<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          302 street,rajapeth behind hdfc bank Amravati</address>
          <p>
            <i class="icon-phone"></i> 	+91 072 3792 3234<br>
            <i class="icon-envelope-alt"></i> JobZpvtltd@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; Jayesh Padhen 2023 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
