      ...
      <div class="container">  
            ...
            <div class="col-md-7">
                ...
                <div class="col-md-8">
                    ...
                    <input class="form-control input-sm" id="FNAME" name="FNAME" placeholder="Firstname" type="text" value="<?php echo isset($appl->FNAME) ? $appl->FNAME : ''; ?>" onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                </div>
            </div>
        </div>
              ...
              <div class="form-group">
                <div class="col-md-7">
                  ...
                  <div class="col-md-8">
                   <div class="col-lg-5">
                      <div class="radio">
                        <label><input checked id="optionsRadios1" checked="True" name="optionsRadios" type="radio" value="Male">Male</label>
                      </div>
                    </div>

                    <div class="col-lg-4">
                      <div class="radio">
                        <label><input id="optionsRadios2"   name="optionsRadios" type="radio" value="Female">Female</label>
                      </div>
                    </div> 
