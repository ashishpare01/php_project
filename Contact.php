    ...
    <section class="ftco-section contact-section bg-light">
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="w-100"></div>
          <div class="col-md-3">
            <p><span>Address:</span>12 street,rajapeth behind hdfc bank, Amravati 444607</p>
          </div>
          <div class="col-md-3">
            <p><span>Phone:</span> <a href="#">+91 072 3792 3234</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Email:</span> <a href="#">JobZpvtltd@gmail.com</a></p>
          </div>
          <div class="col-md-3">
            <p><span>Website</span> <a href="#">JobZ.com</a></p>
          </div>
        </div>
